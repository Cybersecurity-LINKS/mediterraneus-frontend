...
import { Card, Button, Form, Col, Row, OverlayTrigger, Tooltip, Figure, Container, Spinner } from 'react-bootstrap';
                ...
                <Form className="mt-3 mb-3 ps-5 pe-5">
                    ...
                    <Card.Body>
                        <Form.Group as={Row} className="flex-fill align-items-center mb-3" controlId="formNFTname">
                            ...
                            <Col sm={1}>
                                <OverlayTrigger overlay={<Tooltip>Unique alias representing the asset and it is used as NFT Name</Tooltip>}>  
