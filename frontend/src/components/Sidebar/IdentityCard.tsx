        ...
        { cretingIdentityLoading 
          ...
          <>
            <OverlayTrigger placement="right" delay={{ show: 200, hide: 200 }} overlay={<Tooltip>Open in explorer</Tooltip>}>          
              <Link target="_blank" to={`https://explorer.shimmer.network/testnet/identity-resolver/${did?.toString()}`} style={{ textDecoration: 'none' }}>{removeCenterOfStr(did!.toString(), 25, 70)}</Link> 
            </OverlayTrigger>
            <Row className='justify-content-md-center'>
              <Col md="auto">
...
export const IdentityCard = () => {
  ...
  return (
      <Card className='mt-3 ms-3' style={{ width: '24rem' }}>
