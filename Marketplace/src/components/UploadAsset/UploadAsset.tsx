...
export const UploadAsset = () => {
    ...
    return (
        ...
        <Card style={{width: '60rem'}} className='d-flex mb-5 mt-3'>
            <Card.Body>
                <Card.Title>Upload an Asset on the Connector ({connectorUrl}) with its Offering Message</Card.Title>
            </Card.Body>
            <Form className="mt-3 mb-3 ps-5 pe-5">
                <Form.Group as={Row} className="flex-fill align-items-center mb-3" controlId="formNFTname">
                    <Form.Label column sm={4} style={{fontSize: "20px"}}>Asset Alias</Form.Label>
                    <Col sm={8}>
                ...
                <Form.Group as={Row} className="flex-fill align-items-center mb-3" controlId="uploadAsset">
                    <Form.Label column sm={4} style={{fontSize: "20px"}}>Upload Asset File</Form.Label>
                    <Col sm={8}>
                ...
                <Form.Group as={Row} className="flex-fill align-items-center mb-3" controlId="uploadOffering">
                    <Form.Label column sm={4} style={{fontSize: "20px"}}>Upload Offering Message File</Form.Label>
                    <Col sm={8}>
                        <Form.Control type="file" size="lg" accept='.json'/>
                    </Col>
                </Form.Group>
                ...
                <Form.Group as={Row} className="flex-fill align-items-center mb-3" controlId="formNFTuri">
                    <Form.Label column sm={4} style={{fontSize: "20px"}}>Offering CID</Form.Label>
                    <Col sm={8}>
                        <Form.Control className="text-truncate"  disabled={true} size="lg" type="text" placeholder="Upload Offering Message to get CID back" 
